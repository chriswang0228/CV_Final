...
arch_list=['Unet','MA','UPP','DLV3']
iou_array=[]
std_array=[]
train_val, X_test = train_test_split(os.listdir(IMAGE_PATH), test_size=0.1, random_state=19)
test_set = DroneTestDataset(IMAGE_PATH, MASK_PATH, X_test, transform=t_test)
iou_list0=[]
iou_list1=[]
for arch in arch_list:
        model=torch.load('../model_weight/'+arch+'.pt')
        model.eval()
